...
# aqui, o objetivo reaproveitar as reads não mapeadas após o alinhamento das amostras originais com as sequências
# já montadas

input_dir="CAMINHO DOS ARQUIVOS APÓS SOAPALIGNER CONTRA AS SEQUÊNCIAS MONTADAS"
