...
qiime feature-classifier extract-reads \
  ...
  --p-f-primer GGMTTAGATACCCBDGTA \
  --p-r-primer GGGTYKCGCTCGTTR \
  --p-n-jobs 12 \
  --o-reads silva-138.1-v56-seqs.qza

qiime feature-classifier fit-classifier-naive-bayes \
  --i-reference-reads silva-138.1-v56-seqs.qza \
  --i-reference-taxonomy silva-138.1-ssu-nr99-tax.qza \
  --o-classifier silva-138.1-v56-classifier.qza
